...
public class BankSteps {
    ...
    public void iVerifyTextDisplayed(String expectedText) throws InterruptedException {
        Assert.assertEquals(new CustomerLoginPage().verifyYourNameTextIsDisplayed(),expectedText,"Your Name is not Displayed");
    }
    ...
    public void verifyTheMessage(String expectedText) throws InterruptedException {
        Assert.assertEquals(new AccountPage().verifyDepositSuccessfullyTextMessage(), expectedText, "No such message found");
    }
    ...
    public void iVerifyTheText(String expectedText) throws InterruptedException {
        Assert.assertEquals(new AccountPage().verifyWithdrawalSuccessfullyTextMessage(), expectedText, "No such message found");
    }
